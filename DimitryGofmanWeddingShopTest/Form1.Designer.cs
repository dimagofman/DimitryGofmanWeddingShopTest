namespace DimitryGofmanWeddingShopTest
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox2.Size = new System.Drawing.Size(464, 312);
			...
			this.label1.Text = "Input commands:";
			// 
			// label2
			// 
			...
			this.label2.Text = "End positions:";
			// 
			// pictureBox1
			// 
			...
			this.pictureBox1.Location = new System.Drawing.Point(509, 47);
			this.pictureBox1.Name = "pictureBox1";
			this.pictureBox1.Size = new System.Drawing.Size(1127, 764);
			...
			this.checkBox1.Text = "&Enable Collisions";
			...
			this.Name = "Form1";
			this.Text = "Dimitry Gofman - Test submission for the Wedding Shop";
